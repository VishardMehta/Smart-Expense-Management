...
const Expense = () => {
  ...
  const handleAddTransaction = async (transactionData) => {
    try {
      await apiService.createTransaction({ ...transactionData, type: 'expense' });
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">
            {filteredTransactions.length} expense{filteredTransactions.length !== 1 ? 's' : ''} found
          </p>
        </div>
        <button
          ...
          <EmptyState
            ...
            description={
              transactions.length === 0 
                ? "Add your first expense to get started with tracking your spending."
                : "Try adjusting your filters to find the expenses you're looking for."
            }
